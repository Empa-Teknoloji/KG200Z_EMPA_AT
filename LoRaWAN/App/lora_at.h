...
#define AT_CERTIF     "+AUTOJOIN"

/* Information command */
#define AT_BAT        "+BAT"

/* USER CODE BEGIN EM */
/* Lora Disconnect command */
#define AT_DISC       "+DISC"

/* Lora Status command */
#define AT_STATUS       "+LORASTAT"

#define AT_TIMERCONF	"+TIMERCONF"

#define AT_TIMERSTART	"+TIMERSTART"

#define AT_TIMERSTOP	"+TIMERSTOP"

#define AT_GETTEMP	"+GETTEMP"


#define AT_I2CSCAN	 "+I2CSCAN"
#define AT_I2CGET	 "+I2CREAD"
#define AT_I2CNGET   "+I2CNREAD"
#define AT_I2CSET	 "+I2CWRITE"
#define AT_I2CNSET 	 "+I2CNWRITE"

#define AT_DESKID 	 "+DESKID"

#define AT_SENDTEMP	"+TEMPSEND"
/* USER CODE END EM */
...
/**
  * @brief  Disconnect from the LoRa network
  * @param  param String parameter
  * @retval AT_OK
  */
...
/**
  * @brief  Configure a timer with given settings
  * @param  param String parameter
  * @retval AT_OK
  */
...
/**
  * @brief  Start a previously configured timer
  * @param  param String parameter
  * @retval AT_OK
  */
